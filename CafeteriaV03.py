...
def abrir_ventana_alumno(root, pedido_existente=None):
    ...
    def ver_especialidad():
        ...
        resultado = funciones_especialidad.ver_detalle_especialidad_con_retorno(root, cola_pedidos)
    ...
    def ir_a_resumen():
        ...
        if especialidad_agregada.get():
            carrito.append(funciones_especialidad.especialidad_del_dia["nombre"])
